                                    ...
                                    <div className="col-lg-12">
                                        <div className="footer-logo-contact-wrap">
                                            <div className="footer-logo">
                                                <a href="index.html">
                                                    <img src="assets/img/software-logo.svg" alt="footer-logo" />
                                                </a>
                                            </div>
                                            <ul className="footer-contact">
                                                ...
                                                <li className="single-contact">
                                                    <span>Email Now</span>
                                                    <h5>
                                                        <a href="/cdn-cgi/l/email-protection#a9c0c7cfc6e9ccd1c8c4d9c5cccec4c8c0c587cac6c4">
                                                            <span
                                                                className="__cf_email__"
                                                                data-cfemail="fe97909891be9b869f938e929b99939f9792d09d9193"
                                                            >
                                                                [email&nbsp;protected]
                                                            </span>
                                                        </a>
