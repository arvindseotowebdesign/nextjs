...
const Header = () => {
    return (
        <>
            ...
            <header className="header-area style-2 bg-dark">
                        ...
                        <ul className="menu-list">
                            ...
                            <li className="menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                    ...
                                    <li>
                                        <a href="portfolio-vertical-grid.html">Portfolio Vertical Grid</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="portfolio-interactive-banner.html">Interactive Banner</a>
                                    </li>
                                    <li>
